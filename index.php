                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-9 col-md-11 col-sm-10">
                                <div class="hero__caption">
                                    <span data-animation="fadeInUp" data-delay="0.2s">Patrick Potter</span>
                                    <h1 data-animation="fadeInUp" data-delay="0.5s">Você no estilo sempre!</h1>
                                </div>
                            </div>
                        </div>
                    </div>          
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="about-caption">
                            ...
                            <div class="section-tittle section-tittle3 mb-35">
                                <span>Sobre Nossa Barbearia</span>
                                <h2>15 anos de experiência aumentando autoestimas</h2>
                            </div>
                            <p class="mb-30 pera-bottom">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione necessitatibus unde commodi, eius doloremque voluptate mollitia facere perspiciatis minima, eligendi cumque aspernatur ex natus sed nobis! Doloribus nihil vitae reprehenderit.</p>
                            <p class="pera-top mb-50">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Molestiae nisi nihil fugiat.</p>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Cortes Personalizados</a></h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption active text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Eleve sua Autoestima</a></h4>
                                <p>Sorem spsum dolor sit amsectetur adipisclit, seddo eiusmod tempor incididunt ut laborea.</p>
                            </div>
                        </div>
                    </div> 
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="services-caption text-center mb-30">
                            ...
                            <div class="service-cap">
                                <h4><a href="#">Horario Flexível</a></h4>
                                <p>Sorem spsum dolor sit amsectetur adipisclit, seddo eiusmod tempor incididunt ut laborea.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-11 col-sm-11">
                        <div class="section-tittle text-center mb-100">
                            <span>Nosso time de Profissionais</span>
                            <h2>Nossos melhores Barbeiros disponível para você</h2>
                        </div>
                    </div>
                </div>
                <div class="row team-active dot-style">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-">
                        <div class="single-team mb-80 text-center">
                            ...
                            <div class="team-caption">
                                <span>Especialista em Tinturas</span>
                ...
                <div class="row justify-content-end">
                    <div class="col-xl-7 col-lg-7">
                        <div class="section-tittle mb-50">
                            ...
                            <h2>Os melhores preços da cidade</h2>
                        </div>
                        <!-- Pricing  -->
                        <div class="row">
